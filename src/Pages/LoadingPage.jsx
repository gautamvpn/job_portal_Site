    ...
    <main className="flex flex-col gap:10 sm:gap-20 py-10 sm:py-20">
      <section className="text-center">
        <h1 className="flex flex-col items-center justify-center text-4xl font-extrabold sm:text-6xl lg:text-8xl tracking-tighter py-4">
          Find Your Dream Job
          <span className="flex items-center gap-2">and get
            <img src="/logo.png" alt="Hired logo" className="h-14 sm:h-24 lg:h-32" />
          </span>
        </h1>

        <p className="text-gray-300 sm:mt-4 text-xs md:text-lg">Explore thousands of job listings or find the perfect candidate</p>
      </section>
      ...
      {/* banner */}
      <img src="/banner.jpeg" alt="banner image" className="w-gull" />
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <Card>
          <CardHeader>
            <CardTitle>For Job Seaker</CardTitle>
          </CardHeader>
          <CardContent>
